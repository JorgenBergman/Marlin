...
#define STRING_CONFIG_H_AUTHOR "(JB, Ender-5 Plus)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Ender5+ SKR-3ez"
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 800, 135.88574 }
 ...
 */
  ...
  #define JUNCTION_DEVIATION_MM 0.0878 // (mm) Distance from real junction edge
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -44, -5, -2.78 }
